...
const TeacherDashboard = ({ user, onNavigate }) => {
  ...
  const testClasses = [
    { subject: 'Matemáticas Aplicadas', students: 28, average: 4.2, time: '08:00 - 10:00' },
    { subject: 'Programación Web', students: 22, average: 4.5, time: '10:30 - 12:30' },
    { subject: 'Base de Datos', students: 25, average: 3.8, time: '14:00 - 16:00' },
    { subject: 'Sistemas Operativos', students: 30, average: 4.0, time: '16:30 - 18:30' },
  ]
          ...
          <div className="flex justify-between items-center py-6">
            ...
            <div className="flex items-center gap-4">
              <div className="text-right">
                ...
                <p className="text-sm font-medium text-gray-900">{user?.role || 'Instructor'}</p>
              </div>
            </div>
          </div>
        </div>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
          <button className="glass-card p-6 hover:shadow-lg transition-all duration-200 text-left group">
            ...
            <h3 className="text-lg font-semibold text-gray-900 mb-2">Nueva Calificación</h3>
            <p className="text-sm text-gray-600">Registrar notas de estudiantes</p>
          </button>
          ...
          <button className="glass-card p-6 hover:shadow-lg transition-all duration-200 text-left group">
            ...
            <p className="text-sm text-gray-600">Ver y editar información de estudiantes</p>
          </button>
          ...
          <button className="glass-card p-6 hover:shadow-lg transition-all duration-200 text-left group">
            ...
            <p className="text-sm text-gray-600">Reportes de rendimiento y estadísticas</p>
          </button>
          ...
          <button className="glass-card p-6 hover:shadow-lg transition-all duration-200 text-left group">
            ...
            <h3 className="text-lg font-semibold text-gray-900 mb-2">Módulos</h3>
            <p className="text-sm text-gray-600">Gestionar contenidos y materiales</p>
          </button>
        </div>
        ...
        <div className="glass-card p-6 mb-8">
          <div className="flex items-center justify-between mb-4">
            <h3 className="text-lg font-semibold text-gray-900">Mis Clases de Hoy</h3>
            ...
            {testClasses.map((classItem, index) => (
              <div key={index} className="flex items-center justify-between p-4 bg-gray-50 rounded-lg">
                <div>
                  ...
                  <p className="text-sm text-gray-600">{classItem.students} estudiantes</p>
                </div>
                <div className="text-right">
                  <p className="text-sm font-medium text-gray-900">{classItem.time}</p>
                  <p className="text-xs text-gray-500">Promedio: {classItem.average}</p>
                </div>
              </div>
            ))}
          </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          ...
          >
            ...
            <h4 className="font-semibold text-gray-900 mb-2">Ver Todos los Reportes</h4>
            <p className="text-sm text-gray-600">Accede a reportes detallados de rendimiento</p>
          </button>
          <button 
          ...
          >
            ...
            <h4 className="font-semibold text-gray-900 mb-2">Lista de Estudiantes</h4>
            <p className="text-sm text-gray-600">Gestiona información de todos los estudiantes</p>
          </button>
          <button 
          ...
          >
            ...
            <p className="text-sm text-gray-600">Ajusta preferencias y configuraciones</p>
          </button>
        </div>
      </div>
    </div>
