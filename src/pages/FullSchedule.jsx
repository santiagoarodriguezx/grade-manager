...
const FullSchedule = ({ user }) => {
  ...
  const weeklySchedule = {
    trimester1: {
      'Lunes': [
        { subject: 'Matemáticas Aplicadas', time: '08:00 - 10:00', room: 'Aula 201', professor: 'Prof. García' },
        { subject: 'Programación Web', time: '10:30 - 12:30', room: 'Lab 1', professor: 'Prof. López' },
        { subject: 'Base de Datos', time: '14:00 - 16:00', room: 'Lab 2', professor: 'Prof. Martínez' },
      ],
      'Martes': [
        { subject: 'Sistemas Operativos', time: '08:00 - 10:00', room: 'Aula 302', professor: 'Prof. Torres' },
        { subject: 'Matemáticas Aplicadas', time: '10:30 - 12:30', room: 'Aula 201', professor: 'Prof. García' },
        { subject: 'Programación Web', time: '14:00 - 16:00', room: 'Lab 1', professor: 'Prof. López' },
      ],
      'Miércoles': [
        { subject: 'Base de Datos', time: '08:00 - 10:00', room: 'Lab 2', professor: 'Prof. Martínez' },
        { subject: 'Sistemas Operativos', time: '10:30 - 12:30', room: 'Aula 302', professor: 'Prof. Torres' },
        { subject: 'Matemáticas Aplicadas', time: '14:00 - 16:00', room: 'Aula 201', professor: 'Prof. García' },
      ],
      'Jueves': [
        { subject: 'Programación Web', time: '08:00 - 10:00', room: 'Lab 1', professor: 'Prof. López' },
        { subject: 'Base de Datos', time: '10:30 - 12:30', room: 'Lab 2', professor: 'Prof. Martínez' },
        { subject: 'Sistemas Operativos', time: '14:00 - 16:00', room: 'Aula 302', professor: 'Prof. Torres' },
      ],
      'Viernes': [
        { subject: 'Matemáticas Aplicadas', time: '08:00 - 10:00', room: 'Aula 201', professor: 'Prof. García' },
        { subject: 'Programación Web', time: '10:30 - 12:30', room: 'Lab 1', professor: 'Prof. López' },
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center py-6">
            <div>
              ...
              <p className="text-gray-600">Horario semanal de {user?.name || 'Estudiante'}</p>
            </div>
            
            <div className="flex items-center gap-4">
              <div className="text-right">
                <p className="text-sm text-gray-600">Horas semanales</p>
                <p className="text-2xl font-bold text-blue-600">{totalHoursPerWeek}h</p>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-5 gap-6 mb-8">
          {days.map((day) => (
            <div key={day} className="glass-card p-6">
              ...
              <h3 className="text-lg font-semibold text-gray-900 text-center mb-6">{day}</h3>
              
              <div className="space-y-4">
                {currentSchedule[day] && currentSchedule[day].length > 0 ? (
                  currentSchedule[day].map((class_, index) => (
                    <div key={index} className="bg-white p-4 rounded-lg shadow-sm border border-gray-100">
                      <h4 className="font-medium text-gray-900 mb-2">{class_.subject}</h4>
        ...
        <div className="glass-card p-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
            ...
            <div className="text-center">
              ...
              <p className="text-2xl font-bold text-gray-900">{Object.values(currentSchedule).flat().length}</p>
            ...
            <div className="text-center">
              ...
              <p className="text-2xl font-bold text-gray-900">
                {[...new Set(Object.values(currentSchedule).flat().map(c => c.subject))].length}
              </p>
