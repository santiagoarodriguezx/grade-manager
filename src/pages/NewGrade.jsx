      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div className="glass-card p-8 text-center">
          ...
          <p className="text-gray-600 mb-6">
            Esta funcionalidad está en desarrollo. Aquí podrás registrar y
            gestionar las calificaciones de tus estudiantes.
          </p>
          <div className="text-sm text-gray-500">
            Próximamente: Formularios de calificación, importación masiva,
            cálculos automáticos y más.
          </div>
        </div>
      </div>
    </div>
